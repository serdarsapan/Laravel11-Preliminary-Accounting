        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(!empty($alis->id))
                        @php
                            $routeLink = route('alis.update',$alis->id);
                        @endphp
                    @else
                        @php
                            $routeLink = route('alis.store');
                        @endphp
                    @endif
                    <form action="{{ $routeLink }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            @if (!is_null($account))
                                @foreach ($account as $acc)
                                    <option value="{{ $alis->bankName ?? '' }}">{{ $acc->name ?? '' }}</option>
                                @endforeach
                            @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 form-group mt-2">
                            ...
                            <div class="form-group mt-2 col-md-2 col-sm-6 col-xs-12" id="etiketAlani">
                                ...
                                <input type="text" name="tags" id="tags" class="form-control" value="{!! $alis->tags ?? '' !!}" />
                            </div>
                        </div>
                        <div class="form-group mt-2">
                            <label for="description" class="label-spe">Açıklama</label>
                            <input type="text" class="form-control" name="description" id="description" 
                                      placeholder="Açıklama" value="{!! $alis->description ?? '' !!}" />
                        </div>
                        <div class="row mt-3">
